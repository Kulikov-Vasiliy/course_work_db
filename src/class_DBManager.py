    ...
    def adding_info_in_table(self, per_company: list[dict]) -> None:
        ...
        with conn.cursor() as cur:
            ...
            for n in per_company:
                ...
                cur.execute("""INSERT INTO public.vacancies (
                    ...
                    """, (
                    n["employer_id"], n["title"], n["alternate_url"], int_from,
                    int_to, n["currency"], n["requirement"], n["responsibility"],
                    n["city"], n["street"], n["building"], n["schedule"], n["name"],
